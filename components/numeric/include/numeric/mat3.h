#ifndef CHROMA_NUMERIC_MAT3_H
#define CHROMA_NUMERIC_MAT3_H
...
template<typename T>
class NUM_EMPTY_BASES Matrix33 :
...
constexpr 
void
swap(numeric::details::Matrix33<T>& lhs, numeric::details::Matrix33<T>& rhs) noexcept {
    const T t00 = lhs[0][0];
    const T t01 = lhs[0][1];
    const T t02 = lhs[0][2];
    const T t10 = lhs[1][0];
