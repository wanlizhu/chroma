#ifndef CHROMA_NUMERIC_MAT4_H
#define CHROMA_NUMERIC_MAT4_H
...
template<typename T>
class NUM_EMPTY_BASES Matrix44 :
...
constexpr
void
swap(numeric::details::Matrix44<T>& lhs, numeric::details::Matrix44<T>& rhs) noexcept {
    const T t00 = lhs[0][0];
    const T t01 = lhs[0][1];
    const T t02 = lhs[0][2];
    const T t03 = lhs[0][3];
